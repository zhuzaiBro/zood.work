...
-- 可选：删除同章节下已存在的 Python Book 种子课时（按固定 id）
...
INSERT INTO public.lessons (
  ...
  '01. 第一个 Python 程序',
  '先建立对 Python 执行方式、缩进规则和 print 输出的直觉。',
  $md1$
## 为什么从 Python 开始
