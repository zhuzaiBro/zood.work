...
const CHAPTER_ID = '553d7163-7efb-4b82-b16b-6978a7e85e3a'
const COURSE_ID = '2afaa677-1f07-4d36-9b25-129a5fd346f1'

const lessons = [
  {
    id: '10100001-0001-4001-8001-553d71630101',
    sort: 0,
    title: '01. 第一个 Python 程序',
    description: '用点外卖、打招呼等生活场景理解 print 与脚本执行。',
    markdown: `
## 为什么从 Python 开始
...
`,
  ...
  {
    id: '10100002-0002-4002-8002-553d71630202',
    sort: 1,
    title: '02. 变量与基本类型',
    description: '用姓名、余额、会员状态等日常信息理解变量与类型。',
    markdown: `
## 变量是什么
...
`,
  ...
  {
    id: '10100003-0003-4003-8003-553d71630303',
    sort: 2,
    title: '03. 条件判断与循环',
    description: '用天气穿衣、排队叫号、每日打卡理解 if 与循环。',
    markdown: `
## 条件判断：生活中的「如果…就…」
...
`,
  ...
  {
    id: '10100004-0004-4004-8004-553d71630404',
    sort: 3,
    title: '04. 函数与参数',
    description: '把「算运费、打招呼」等重复动作封装成函数。',
    markdown: `
## 函数：把重复动作打包
...
`,
  ...
  {
    id: '10100005-0005-4005-8005-553d71630505',
    sort: 4,
    title: '05. 列表、字典与数据组织',
    description: '用购物清单、通讯录、订单列表理解 list 和 dict。',
    markdown: `
## 列表 list：有序清单
...
`,
  ...
  {
    id: '10100006-0006-4006-8006-553d71630606',
    sort: 5,
    title: '06. 文件、模块与小项目思维',
    description: '用记账本、配置文件理解读写文件与模块拆分。',
    markdown: `
## 读写文件：像打开笔记本
...
`,
  ...
  {
    id: '10100007-0007-4007-8007-553d71630707',
    sort: 6,
    title: '07. 类 class 与对象',
    description: '用「用户账号、外卖订单」建模，理解面向对象。',
    markdown: `
## 类是什么
...
`,
  ...
  {
    id: '10100008-0008-4008-8008-553d71630808',
    sort: 7,
    title: '08. 枚举 Enum',
    description: '用订单状态、会员等级等固定选项理解 Enum。',
    markdown: `
## 枚举解决什么问题
...
`,
  ...
  {
    id: '10100009-0009-4009-8009-553d71630909',
    sort: 8,
    title: '09. 访问修饰与装饰器 @',
    description: '理解 _ 前缀约定与 @property、@staticmethod 等常见装饰器。',
    markdown: `
## Python 的「访问修饰」
...
const lines = []
lines.push('-- 导入 Python 基础文档课时到 lessons')
lines.push(`-- course_id: ${COURSE_ID}`)
lines.push(`-- chapter_id: ${CHAPTER_ID}`)
lines.push('-- 在 Supabase SQL Editor 中执行')
lines.push('')
lines.push('BEGIN;')
lines.push('')
lines.push('DELETE FROM public.lessons')
...
for (const lesson of lessons) {
  const md = dollarQuote(lesson.markdown, `md${lesson.sort + 1}`)
  lines.push('INSERT INTO public.lessons (')
  lines.push('  id, chapter_id, title, description, content_markdown,')
  lines.push('  video_id, video_url, duration, is_free, is_locked, sort_order')
  lines.push(') VALUES (')
  lines.push(`  '${lesson.id}',`)
  lines.push(`  '${CHAPTER_ID}',`)
  lines.push(`  '${lesson.title.replace(/'/g, "''")}',`)
  lines.push(`  '${lesson.description.replace(/'/g, "''")}',`)
  lines.push(`  ${md},`)
  lines.push('  NULL, NULL, NULL, true, false,')
  lines.push(`  ${lesson.sort}`)
  lines.push(')')
  lines.push('ON CONFLICT (id) DO UPDATE SET')
  lines.push('  chapter_id = EXCLUDED.chapter_id,')
  lines.push('  title = EXCLUDED.title,')
  lines.push('  description = EXCLUDED.description,')
  lines.push('  content_markdown = EXCLUDED.content_markdown,')
  lines.push('  video_id = NULL, video_url = NULL, duration = NULL,')
  lines.push('  is_free = EXCLUDED.is_free,')
  lines.push('  is_locked = EXCLUDED.is_locked,')
...
lines.push('')
lines.push('-- 验证')
lines.push('SELECT id, title, sort_order,')
lines.push('       CASE WHEN content_markdown IS NULL THEN 0 ELSE length(content_markdown) END AS md_len')
lines.push('FROM public.lessons')
lines.push(`WHERE chapter_id = '${CHAPTER_ID}'`)
lines.push('ORDER BY sort_order;')

const out = '.sql/seed_python_book_lessons.sql'
fs.writeFileSync(out, lines.join('\n'))
console.log('Wrote', out, fs.statSync(out).size, 'bytes,', lessons.length, 'lessons')
