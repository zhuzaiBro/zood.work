            ...
            <div className="flex-grow space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <ReferralShareButton
                  ...
                  className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-6 py-2 font-medium text-gray-700 transition-colors hover:bg-gray-50"
                />
              </div>
            </div>
          </div>
